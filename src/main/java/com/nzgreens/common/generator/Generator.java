package com.nzgreens.common.generator; /**
...
public class Generator {
    ...
    private Map<String, VelocityContext> analyzeData(ConfigBuilder config) {
        ...
        for (TableInfo tableInfo : tableList) {
            ...
            ctx.put("model", tableInfo.getEntityName());
    ...
    public Generator setDataSource(DataSourceConfig dataSource) {
    ...
    public Generator setStrategy(StrategyConfig strategy) {
    ...
    public Generator setPackageInfo(PackageConfig packageInfo) {
    ...
    public Generator setTemplate(TemplateConfig template) {
    ...
    public Generator setConfig(ConfigBuilder config) {
        this.config = config;
        return this;
    }
    ...
    public Generator setCfg(InjectionConfig injectionConfig) {

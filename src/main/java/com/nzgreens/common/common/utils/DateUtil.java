...
public class DateUtil {
	...
	public static final String[] FORMATS = new String[] { DAY, MONTH, MINUTE, SECOND, MILLISECOND, DAY_N, MONTH_N,
			MINUTE_N, SECOND_N, MILLISECOND_N };
	...
	public static Date getFirstDay() {
		String firstDay = "1970-01-01";
		return parse(firstDay, DAY);
	}
	 ...
	 * @param date
	 */
	public static Date getCreateStart(Date date){
		if(date == null) {
			return null;
		}
		DateTime dateTime = new DateTime(date);
		dateTime = new DateTime(dateTime.toString("yyyy-MM-dd"));
		return dateTime.plusHours(5).toDate();
	}
	 ...
	 * @param date
	 */
	public static Date getCreateEnd(Date date){
		if(date == null) {
			return null;
		}
		DateTime dateTime = new DateTime(date);
		dateTime = new DateTime(dateTime.toString("yyyy-MM-dd"));
		return dateTime.plusDays(1).plusHours(5).toDate();
	}

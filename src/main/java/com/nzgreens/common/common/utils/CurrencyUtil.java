...
//		}
	...
	public static void main(String[] args) throws Exception {
		/*System.out.println(CurrencyUtil.convertYuanToFen("1.123"));
		System.out.println(CurrencyUtil.convertYuanToFen("1.120"));
        System.out.println(CurrencyUtil.convertYuanToFen("1.125"));
        System.out.println(CurrencyUtil.convertYuanToFen("1.129"));
        System.out.println("f2y");
        System.out.println(CurrencyUtil.convertFenToYuan("101.0"));
        System.out.println(CurrencyUtil.convertFenToYuan("101.1"));
        System.out.println(CurrencyUtil.convertFenToYuan("101.5"));
        System.out.println(CurrencyUtil.convertFenToYuan("101.9"));
        System.out.println("fixy");
        System.out.println(CurrencyUtil.fixYuanAmount("1.001"));
        System.out.println(numberFormatAmount("100000"));
        System.out.println(numberFormatAmount("100000123123123123.123"));
        System.out.println(numberFormatAmount("0"));
        System.out.println(numberFormatAmount("0.00214"));
        System.out.println("fixf");
        System.out.println(CurrencyUtil.fixFenAmount("1.00"));
        System.out.println(CurrencyUtil.fixFenAmount("1.01"));
        System.out.println(CurrencyUtil.fixFenAmount("1.05"));
        System.out.println(CurrencyUtil.fixFenAmount("1.09"));*/
		System.out.println(CurrencyUtil.divide(3321, 114, 4));
	}
}
